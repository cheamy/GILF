...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default='GILF_SSR')

    parser.add_argument('--trainset_dir', type=str,
                        default='/home/vision/work/zh/PycharmProjects/BasicLFSR/data_for_training/SR_5x5_2x/')
    parser.add_argument('--testset_dir', type=str,
                        default='/home/vision/work/zh/PycharmProjects/BasicLFSR/data_for_test/SR_5x5_2x/')
    ...
    parser.add_argument('--model_path', type=str, default='../save/checkpoint_HCI_2x/GILF_SSR_2xSR_5x5_epoch_17.pth.tar')

    parser.add_argument('--tag', type=str, default='HCI_2x')##
...
def train(cfg, train_loader, test_Names, test_loaders):
    ...
    net = Net(cfg.angRes,cfg.angRes, cfg.upscale_factor)
...
def main(cfg):
    ...
    train_set = TrainSetLoader_k(dataset_dir=cfg.trainset_dir)
    train_loader = DataLoader(dataset=train_set, num_workers=8, batch_size=cfg.batch_size, shuffle=True)
    test_Names, test_Loaders, length_of_tests = MultiTestSetDataLoader(cfg, ['HCI_old','HCI_new'])
